package co.deepmindz.adminmainservice.exception;
...
public class GlobalExceptionHandlers extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleResourceAlreadyExist(ResourceAlreadyExist resourceAlreadyExist, WebRequest webRequest){
        ErrorDetails errorDetails = new ErrorDetails(
                LocalDateTime.now(),
                resourceAlreadyExist.getMessage(),
                400,
